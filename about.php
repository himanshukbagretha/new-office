...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Nursing Agency in Indore - Ishaan Home Health Care</title>
        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        <meta content="" name="keywords">
        <meta content="Discover top patient care services in Indore with Ishaan Home Health Care, your trusted nursing agency for compassionate home health support." name="description">
                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="border-end py-1">
                            <a href="https://www.instagram.com/ishaanhomehealthcareservices/" class="btn text-secondary"><i class="fab fa-instagram"></i></a>
                        </div>
                        <div class="border-end py-1">
        ...
        <div class="container-fluid bg-secondary wow zoomInDown" data-wow-delay="0.1s">
            <div class="container">
                <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center text-center p-5">
                    <h1 class="me-4"><span class="fw-normal">Contact us for </span><span>best patient care.</span></h1>
        ...
        <div class="container-fluid team pb-5">
            <div class="container pb-5">
                <div class="pb-5">
                    ...
                    <h1 class="display-2 mb-0 wow fadeInUp" data-wow-delay="0.3s">Our Team Member</h1>
                </div>
                <div class="team-carousel owl-carousel pt-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item border rounded wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="team-content text-center p-4">
                            <a href="#" class="h4">Rupendra Singh Sengar</a>
                            <p class="mb-0 text-primary">Managing Director</p>
                        </div>
                    </div>
                    <div class="team-item border rounded wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="team-content text-center p-4">
                            <a href="#" class="h4">Vineet Pandey</a>
                            <p class="mb-0 text-primary">PA of MD</p>
                        </div>
                    </div>
                    <div class="team-item border rounded wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="team-content text-center p-4">
                            <a href="#" class="h4">Siddarth Singh</a>
                            <p class="mb-0 text-primary">Relationship Manager</p>
                        </div>
                    </div>
                    <div class="team-item border rounded wow fadeInUp" data-wow-delay="0.7s">
                        ...
                        <div class="team-content text-center p-4">
                            <a href="#" class="h4">Shivam Sharma</a>
                            <p class="mb-0 text-primary">Senior Client Coordinator</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="footer-item d-flex flex-column">
                            <div class="footer-item">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-lg-square btn-dark  rounded-circle mx-2" href="https://www.instagram.com/ishaanhomehealthcareservices/"><i class="fab fa-instagram white-icon"></i></a>
